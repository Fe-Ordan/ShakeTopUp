 ...
 */
public class FragmentVAS extends Fragment implements ListItemClickListener {
    ...
    private void setList(int type, int operatorID, int start) {
        ...
        DatabaseReference codeListReference = FirebaseDatabase.getInstance().getReference().child("vas");
    ...
    public void clickPosition(int position, int id) {
        switch (id) {
            ...
            case R.id.arrow:
                ...
                intent.setData(ussdToCallableUri(array.get(position).getShortCode()));
